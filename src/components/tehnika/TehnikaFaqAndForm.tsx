...
interface TehnikaFaqAndFormProps {
  phoneNumber: string;
...
export default function TehnikaFaqAndForm({
  phoneNumber,
  whatsappNumber,
  telegramUsername,
  formData,
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <FaqItem
                question="Вы работаете с газовой техникой?"
                answer="Нет, только с электрической бытовой техникой — стиральные машины, холодильники, духовки, посудомойки. Газовые плиты и колонки не ремонтирую."
              />
              <FaqItem
                question="Даёте ли вы гарантию на работу?"
                answer="Да, на все выполненные работы даю гарантию 30 дней. Если проблема возникнет снова — приеду и устраню бесплатно."
              />
              <FaqItem
                question="Сколько времени занимает ремонт?"
                answer="Простые работы (замена шлангов, фильтров) — 30–60 минут. Сложный ремонт может занять 2–3 часа или потребовать повторного визита."
              />
              <FaqItem
                question="А если детали нужно заказать?"
                answer="Оцениваю стоимость и срок доставки заранее. Как только детали приедут — приеду и установлю в удобное для вас время."
              />
              <FaqItem
                question="Можно ли отказаться от ремонта после диагностики?"
                answer="Конечно. Вы платите только за диагностику (490 ₽), если решите не ремонтировать. Никаких обязательств."
              />
              <FaqItem
                question="Вы работаете в выходные?"
                answer="Да, работаю без выходных. Выезжаю в течение 1–3 часов после вашей заявки."
              />
            </div>
          </div>
        </div>
              ...
              <CardContent className="p-10 md:p-14">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground text-lg">
                    Опишите проблему — отвечу в течение 5–10 минут
                  </p>
                </div>
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      placeholder="Например: стиральная машина Samsung"
                  ...
                  <div>
                    ...
                    <Textarea
                      placeholder="Что случилось с техникой? Когда заметили проблему?"
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="border-t border-white/20 pt-8">
              ...
              <p className="text-white/60 text-sm mt-2">
                © 2024 Ремонт бытовой техники на дому
              </p>
            </div>
          </div>
        </div>
